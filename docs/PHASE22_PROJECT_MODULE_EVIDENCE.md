...
> 日期：2026-09-02
> 范围：项目列表/工作台高保真接入、固定默认入口、项目列表筛选/分页、绑定原型服务端搜索分页、MCP 签出门禁、预览运行时容错
...
| 16077 当前 release | `20260902-095755-97fc9e9a` |
| 当前 release SHA-256 | `636212de436295b82b9cb7639a0c22b56b1676fd20bd19124a2034c2dcca0dff` |
| 16077 备份 | `20260902-100653-pre-test-20260902-095755-97fc9e9a` |
