...
const helpDocumentRoutes = require('./routes/help-documents');
const helpCategoryRoutes = require('./routes/help-categories');
...
async function startServer() {
  ...
  app.use('/api/help-documents', helpDocumentRoutes);
  app.use('/api/help-categories', helpCategoryRoutes);
